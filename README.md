...
Note: this app uses the Geocoder gem to convert user-inputted addresses to the appropriate latitude and longitude. If your order contains an unambiguous address or a nonexistent address, it will not appear on Google Maps.
